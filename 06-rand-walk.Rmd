...
We'll see that the number of paths that end at $X_{2k}=0$ and hit level 1 somewhere before that is the same as the number of paths that start at $X_0=0$ and end at $X_{2k}=2$... See the graph below.
